<?php
    ...
    $errors     = fetchErrors();
    $activeItem = isset($_GET['item']) ? genres()->findById($_GET['item']) : null;
...
<div class="container-fluid body-content p-0 m-0">
    ...
    <div class="container p-4">
        <div class="row">
            <div class="col-sm-12">
                <div class="bg-light p-4 rounded">
                    ...
                    <p class="lead">Genre is represent with name</p>
                    <p>Genres of books simply specify what categories or sub-categories does a book belong to</p>
                </div>
            </div>
        </div>
        ...
        <div class="row mt-4">
            <div class="col-sm-12">
                <form action="genres-processors.php" method="POST" class="bg-light rounded p-4">
